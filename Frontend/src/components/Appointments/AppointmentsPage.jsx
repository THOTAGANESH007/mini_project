      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-gray-800">Service Appointment Portal</h1>
            <p className="mt-3 text-gray-600">Schedule a service visit with our department experts</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div className="bg-blue-600 px-6 py-4">
              ...
              <p className="text-blue-100 text-sm">Fill out the form below to schedule your appointment</p>
            </div>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-6">
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    Please provide enough detail for our team to understand your requirements
                  </p>
                </div>
