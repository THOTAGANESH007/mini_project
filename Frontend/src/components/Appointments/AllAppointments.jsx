...
const AllAppointments = () => {
    ...
    const fetchAppointments = async () => {
      ...
      try {
        const res = await axios.get(
          "http://localhost:9999/api/appointments/byUser",
          {
  ...
  const filteredAppointments = appointments.filter((appt) => {
    // Filter by status
    if (activeTab === "pending" && appt.appointmentStatus !== "Pending")
      return false;
    if (activeTab === "accepted" && appt.appointmentStatus !== "Accepted")
      return false;
              ...
              {filteredAppointments.map((appt) => (
                ...
                >
                  <div className="flex items-start">
                    <div
                      className={`flex-shrink-0 rounded-full p-2 ${getStatusColor(
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-gray-800">
                      {formatDateDisplay(selectedAppointment.appointmentDate)}
                    </p>
                  </div>
