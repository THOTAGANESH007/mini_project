  ...
  if (loading) return (
    <div className="flex items-center justify-center min-h-screen bg-gray-50">
      <div className="text-center">
        ...
        <p className="mt-4 text-gray-700 font-medium">Loading appointments...</p>
      </div>
    </div>
  );
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        {appointments.length === 0 ? (
          <div className="bg-white rounded-xl p-8 shadow-md text-center">
            ...
            <p className="text-gray-500">There are currently no appointments scheduled for the {department} department.</p>
          </div>
        ) : (
              ...
              >
                <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100 hover:shadow-lg hover:border-blue-100 transition duration-300">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="text-gray-400 text-sm">ID: {appt._id.substring(0, 8)}...</div>
                  </div>
