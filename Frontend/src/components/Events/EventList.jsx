    ...
    <div className='bg-gray-50 min-h-screen pb-12'>
      <div className='max-w-6xl mx-auto px-4 sm:px-6 pt-8'>
        ...
        <div className='text-center mb-8'>
          <h1 className='text-4xl font-bold text-gray-800 mb-2'>Events Explorer</h1>
        ...
        <div className='bg-white rounded-xl shadow-md p-6 mb-8'>
          <h2 className='text-xl font-semibold text-gray-800 mb-4'>Filter Events</h2>
        ...
        <div className='flex justify-between items-center mb-6'>
          <h2 className='text-2xl font-bold text-gray-800'>
            Events <span className='text-gray-500'>({filteredEvents.length})</span>
          </h2>
            ...
            <nav className='inline-flex rounded-md shadow-sm -space-x-px' aria-label='Pagination'>
              ...
              {totalPages <= 7 ? (
                ...
                <>
                  ...
                  {[...Array(Math.min(3, totalPages - currentPage))].map((_, idx) => {
