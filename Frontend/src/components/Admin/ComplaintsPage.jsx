  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-800">
      ...
      <div className="bg-white py-6 px-4 shadow-sm">
        <h1 className="text-3xl font-bold text-center text-gray-700">Complaints Dashboard</h1>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg p-6 mb-8 shadow-sm border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div>
              <label className="block text-gray-600 mb-2 text-sm font-medium">Category</label>
              <select
            ...
            <div>
              <label className="block text-gray-600 mb-2 text-sm font-medium">Status</label>
              <select
                value={filterStatus}
                onChange={(e) => {
            ...
            <div className="lg:col-start-4">
              <label className="block text-gray-600 mb-2 text-sm font-medium">Cards per page</label>
              <select
                value={rowsPerPage}
        ...
        <div className="flex justify-between items-center mb-6">
          <div className="text-gray-600">
            Showing <span className="font-medium text-gray-800">{Math.min(filteredComplaints.length, currentComplaints.length)}</span> of <span className="font-medium text-gray-800">{filteredComplaints.length}</span> complaints
          </div>
          ...
          <>
            {currentComplaints.length > 0 ? (
                ...
                {currentComplaints.map((complaint) => (
                  ...
                  >
                    <div className="relative">
                      ...
                      />
                      <div className={`absolute top-3 right-3 ${statusColors[complaint.status]} text-white text-xs font-bold px-3 py-1 rounded-full`}>
                        {complaint.status}
                      </div>
                    </div>
                    ...
                    <div className="p-4">
                      ...
                      <div>
                        <div className="text-gray-500 text-sm mb-1">User ID</div>
                        <div className="font-medium text-gray-800 truncate">{complaint.userId}</div>
                      </div>
                    </div>
                  </div>
                ))}
              ...
              <div className="bg-white rounded-lg p-12 text-center shadow-sm border border-gray-200">
                <div className="text-3xl text-gray-400 mb-2">No complaints found</div>
