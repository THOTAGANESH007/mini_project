  ...
  if (loading) {
    return (
      <div className="h-screen flex flex-col items-center justify-center bg-gray-50">
        ...
        <p className="mt-4 text-gray-600 font-medium">Loading complaint details...</p>
      </div>
    );
  }
    ...
    return (
      <div className="h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center p-8 bg-white rounded-xl shadow-lg max-w-md">
          ...
          <p className="text-red-600 font-medium text-lg mb-4">{error || 'Complaint details not found.'}</p>
          <button
            onClick={() => navigate('/')}
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-0 left-0 p-6">
              <h2 className="text-3xl font-bold text-white mb-2">Complaint Details</h2>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium
                    ${complaint.status === 'Resolved' ? 'bg-green-100 text-green-800' : 
                      ...
                      complaint.status === 'Accepted' ? 'bg-blue-100 text-blue-800' : 
