...
if(!places)return;
  ...
  <div className="flex flex-col items-center bg-gray-100 py-10 mb-[10px]">
    <h1 className="text-2xl font-semibold text-center mx-auto">No Places Found</h1>
    <p className="text-gray-600 mt-2 text-center mx-auto">Please check back later.</p>
  </div>):(
    <div className="flex flex-col items-center bg-gray-100 py-10 mb-[10px]">
