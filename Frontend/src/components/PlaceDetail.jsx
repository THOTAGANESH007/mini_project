...
const PlaceDetail = () => {
  ...
  <div className="bg-white shadow-lg rounded-lg p-6 w-full lg:w-1/2">
    ...
    />
    <p className="text-gray-600 mt-2"><div className="mr-2 font-semibold">About the place:</div>{place.description}</p>
  ...
  <div className="rating flex">
    {[...Array(5)].map((_, i) => (
      <input
        ...
        type="radio"
        readOnly
        className={`mask mask-star-2 ${i < place.avgRating ? "bg-yellow-400" : "bg-gray-300"} ml-1`}
  ...
  {/* Map Section */}
  <div className="bg-white shadow-lg rounded-lg p-6 w-full lg:w-1/2">
    <h3 className="text-xl font-semibold mb-2 text-center text-blue-600">Live Location</h3>
